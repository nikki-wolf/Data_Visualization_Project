// Reading from Wine_History_List: 
d3.json("/api_history/year=2000").then (function (wineData) {
...
function handleSubmit() {
  ...
  var stock = d3.select("#yearInput").node().value;
  console.log(stock);
...
function buildPlot(stock) {
  var apiKey = "sb11sGBzjxjTS2Ss9Px3";
